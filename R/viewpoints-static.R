...
new_static_viewpoint("pc_set",
                     ...
                     discrete = TRUE,
                     mapping = function() hvrmap::map_pc_chord$pc_set_id)

new_static_viewpoint("bass_pc",
                     alphabet_size = 12L,
                     discrete = TRUE,
                     mapping = function() hvrmap::map_pc_chord$bass_pc_id)

new_static_viewpoint("root_pc",
                     alphabet_size = 12L,
                     discrete = TRUE,
                     mapping = function() hvrmap::map_pc_chord$root_pc_id)

new_static_viewpoint("bass_pc_rel_root",
                     alphabet_size = 12L,
                     discrete = TRUE,
                     mapping = function() hvrmap::map_pc_chord$bass_pc_rel_root_id)

new_static_viewpoint("pc_chord_type",
                     hrep::alphabet_size("pc_chord_type"),
                     discrete = TRUE,
                     mapping = function() hvrmap::map_pc_chord$pc_chord_type_id)
